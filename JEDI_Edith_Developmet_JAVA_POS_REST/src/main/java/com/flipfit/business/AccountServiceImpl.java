...
public class AccountServiceImpl implements AccountService {
  ...
  // Declare fields without forcing concrete implementations so they can be injected.
  ...
  /**
   * Default constructor preserves legacy behavior (creates default DAO implementations).
   */
  ...
  /**
   * Constructor for dependency injection (used by REST wiring/tests).
   */
  public AccountServiceImpl(UserDAO userDAO, GymCustomerDAO gymCustomerDAO, GymOwnerDAO gymOwnerDAO, GymService gymService) {
    this.userDAO = userDAO;
    this.gymCustomerDAO = gymCustomerDAO;
